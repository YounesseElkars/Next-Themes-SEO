...
const SocialLink: FC<SocialLinksProps> = ({ Logo, link, name, size, showText = true }) => {
  return (
    <Link href={link} aria-label={name} target="_blank">
      <div className="flex w-full items-center justify-center gap-3 underline decoration-primary/50 underline-offset-8 hover:bg-primary/10 active:bg-primary/30">
        <Logo size={size} />
